// Programma per aggiornare record in una tabella usando JDBC
...
public class update {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
		...
		try {
            ...
            int result = stmt.executeUpdate("update quotidiani set ??");
            ...
            if (result > 0) {
                ...
                System.out.println("Record non AGGIORNATO. Verificare funzione");
			}
